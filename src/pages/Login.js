...
export default function Login() {
  return (
    <AuthLayout
      title={"Welcome back."}
      sub={"Sign in to your merchant account to manage payments."}
      footer={
        <p>
          New here?{" "}
          <Link to="/register" className="font-medium text-action-blue hover:underline underline-offset-4" data-testid="goto-register-link">
            Create an account
          </Link>
        </p>
      }
    >
      <div className="flex flex-col gap-sm">
        ...
        <div className="relative flex items-center py-md my-xs">
          ...
          <span className="flex-shrink-0 mx-md text-[12px] uppercase tracking-widest font-sans text-muted">Or</span>
          <div className="flex-grow border-t border-hairline"></div>
        </div>
